...
from screening_comparison_rules import selected_records_for  # noqa: E402
...
def main() -> None:
    ...
    write_csv(RESULT_DIR / "screening_comparison_counterfactual_full_added_records.csv", added)
    write_csv(RESULT_DIR / "screening_comparison_counterfactual_full_combo_summary.csv", combo_summary(added))
    write_csv(RESULT_DIR / "screening_comparison_counterfactual_event_accounting.csv", accounting_summary(added))
