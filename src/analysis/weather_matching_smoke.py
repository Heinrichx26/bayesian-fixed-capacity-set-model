...
from screening_comparison_rules import score_records  # noqa: E402
...
def main() -> None:
    ...
    write_csv(RESULT_DIR / "weather_matching_smoke_matched_component_records.csv", matched[:1000])
    write_csv(RESULT_DIR / "weather_matching_smoke_coverage.csv", coverage)
    write_csv(RESULT_DIR / "weather_matching_smoke_yearly.csv", yearly)
    write_csv(RESULT_DIR / "weather_matching_smoke_aggregate.csv", aggregate_rows)
