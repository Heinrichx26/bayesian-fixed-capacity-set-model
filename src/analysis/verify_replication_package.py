...
REQUIRED_FILES = [
    ...
    "src/analysis/bayesian_set_core.py",
    "src/analysis/bayesian_set_experiments.py",
    "src/analysis/bayesian_set_feature_comparison.py",
    "src/analysis/amm_synthetic_validation.py",
    "src/analysis/amm_decision_validation.py",
    "src/figures/build_amm_artifacts.py",
    "src/figures/build_amm_synthetic_artifacts.py",
...
FORBIDDEN_TEXT = [
    chr(68) + chr(58) + chr(92),
    chr(67) + chr(58) + chr(92) + "Users",
    "2025" + "data",
    "CC" + "BRS",
    "cc" + "brs",
    "base" + "line",
    ...
    "Expert" + " Systems",
    "ES" + "WA",
    chr(68) + chr(58) + chr(92) + "2025" + "data",
]
...
def main() -> int:
    ...
    for path in PROJECT_ROOT.rglob("*"):
        if path.is_file() and ".git" not in path.parts:
            ...
            if any(pattern.lower() in rel.lower() for pattern in EXCLUDED_PATTERNS):
                excluded.append(rel)
    if excluded:
        return fail("excluded publication files found: " + ", ".join(excluded))
    ...
    print(f"Checked {len(REQUIRED_FILES)} required files and excluded publication artifacts.")
    return 0
